...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-white flex flex-col items-center justify-center text-center px-4">
      ...
      <p className="text-lg md:text-xl mb-4">We're crafting the ultimate global directory for tattoo artists.</p>
      {/* <div className="text-2xl font-mono text-accent">
        {timeLeft.days}d : {timeLeft.hours}h : {timeLeft.minutes}m : {timeLeft.seconds}s
      </div> */}
      <p className="text-sm text-gray-400">Stay tuned for our launch!</p>
    </div>
  );
}
